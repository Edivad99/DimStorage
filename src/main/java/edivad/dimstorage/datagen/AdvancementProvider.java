  ...
  private static class Advancements implements ForgeAdvancementProvider.AdvancementGenerator {
    ...
    public void generate(HolderLookup.Provider registries, Consumer<Advancement> consumer,
      ...
      var ROOT_DIMCORE = Advancement.Builder.advancement()
          ...
          .save(consumer, new ResourceLocation(DimStorage.ID, "root"), existingFileHelper);
      ...
      var DIMCHEST = Advancement.Builder.advancement()
          ...
          .parent(ROOT_DIMCORE)
          .save(consumer, new ResourceLocation(DimStorage.ID, "dimensional_chest"),
              existingFileHelper);
      ...
      Advancement.Builder.advancement()
          ...
          .parent(ROOT_DIMCORE)
          .save(consumer, new ResourceLocation(DimStorage.ID, "dimensional_tank"),
              existingFileHelper);
      ...
      Advancement.Builder.advancement()
          ...
          .parent(DIMCHEST)
          .save(consumer, new ResourceLocation(DimStorage.ID, "dimensional_tablet"),
              existingFileHelper);
    }
  }
}
