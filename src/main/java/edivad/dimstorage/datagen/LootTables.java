...
public class LootTables extends BlockLootSubProvider {
  ...
  protected void generate() {
    this.add(Registration.DIMCHEST.get(),
        (block -> createStandardTable(block, Registration.DIMCHEST_TILE.get())));
    this.add(Registration.DIMTANK.get(),
        (block -> createStandardTable(block, Registration.DIMTANK_TILE.get())));
  }
