...
public abstract class TOPElement implements IElement {
    ...
    public void render(PoseStack poseStack, int x, int y)
    {
        ...
        renderScaledText(poseStack, Minecraft.getInstance(), x + 4, y + 3, textColor, getWidth() - 8, getText());
    }
    ...
    protected static void renderScaledText(PoseStack poseStack, Minecraft mc, int x, int y, int color, int maxWidth, TextComponent component)
    {
        ...
        else
        {
            ...
            mc.font.draw(poseStack, text, (int) (x * reverse), (int) ((y * reverse) + yAdd), color);
            poseStack.popPose();
        }
