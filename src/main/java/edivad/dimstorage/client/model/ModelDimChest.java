...
public class ModelDimChest extends Model {
    ...
    private ModelPart top1;
    private ModelPart top2;
    private ModelPart top3;
    private ModelPart top4;
    private ModelPart top5;
    private ModelPart movable;
    private ModelPart indicatorGreen, indicatorBlue, indicatorRed;
    ...
    public ModelDimChest()
    {
        ...
        movable = new ModelPart(this, 70, 24);
    ...
    private ModelPart createIndicator(int offsetY)
    {
        ModelPart indicator = new ModelPart(this, 0, offsetY);
