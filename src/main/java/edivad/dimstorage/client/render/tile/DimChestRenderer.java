...
public class DimChestRenderer implements BlockEntityRenderer<TileEntityDimChest> {
    ...
    public static LayerDefinition createStaticLayer()
    {
        ...
        partDefinition.addOrReplaceChild("base", CubeListBuilder.create()
                ...
                .mirror(true), PartPose.offset(-8F,11F,-8F));

        partDefinition.addOrReplaceChild("top1", CubeListBuilder.create()
                .texOffs(66,2)
                .addBox(0F, 0F, 0F,16,3,2)
                .mirror(true), PartPose.offset(-8F,8F,-8F));

        partDefinition.addOrReplaceChild("top2", CubeListBuilder.create()
                .texOffs(0,32)
                .addBox(0F, 0F, 0F,2,3,14)
                .mirror(true), PartPose.offset(6F,8F,-6F));

        partDefinition.addOrReplaceChild("top3", CubeListBuilder.create()
                .texOffs(36,32)
                .addBox(0F, 0F, 0F,2,3,14)
                .mirror(true), PartPose.offset(-8F, 8F, -6F));

        partDefinition.addOrReplaceChild("top4", CubeListBuilder.create()
                .texOffs(66,10)
                .addBox(0F, 0F, 0F,12, 3, 2)
                .mirror(true), PartPose.offset(-6F, 8F, 6F));

        partDefinition.addOrReplaceChild("top5", CubeListBuilder.create()
                .texOffs(72,32)
                .addBox(0F, 0F, 0F,12, 2, 6)
                .mirror(true), PartPose.offset(-6F, 8F, 0F));
    ...
    public static LayerDefinition createMovableLayer()
    {
        MeshDefinition meshDefinition = new MeshDefinition();
        PartDefinition partDefinition = meshDefinition.getRoot();
        partDefinition.addOrReplaceChild(MOVABLE, CubeListBuilder.create()
                .texOffs(70,24)
                .addBox(0F, 0F, 0F,12, 1, 6)
                .mirror(true), PartPose.offset(-6F, 8.533334F, -6F));
    ...
    public static LayerDefinition createIndicatorLayer(int offsetY)
    {
        ...
        partDefinition.addOrReplaceChild(MOVABLE, CubeListBuilder.create()
                ...
                .mirror(true), PartPose.offset(-5F, 7.5F, 4F));
